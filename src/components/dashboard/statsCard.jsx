  ...
  const sections = [
    {
      title: "Subscriptions",
      cards: [
        { label: "Total", value: stats?.subscriptions.total, color: "text-blue-500", bg: "bg-blue-50", link: "/subscriptions",
        ...
        { label: "Active", value: stats?.subscriptions.active, color: "text-[#2CD377]", bg: "bg-[#2CD377]/10", link: "/subscriptions?status=active",
          icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
        },
        { label: "Paused", value: stats?.subscriptions.paused, color: "text-yellow-500", bg: "bg-yellow-50", link: "/subscriptions?status=paused",
          icon: <path strokeLinecap="round" strokeLinejoin="round" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" />,
        },
        { label: "Expired", value: stats?.subscriptions.expired, color: "text-red-500", bg: "bg-red-50", link: "/subscriptions?status=expired",
    ...
    },
    {
      title: "Waitlist",
      cards: [
        { label: "View Waitlist", value: "📋", color: "text-[#2CD377]", bg: "bg-[#2CD377]/10", link: "/waitlist",
